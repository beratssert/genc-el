...
class InstituionLogin extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<InstituionLogin> createState() {
    return _InstituionLoginState();
  }
}

class _InstituionLoginState extends ConsumerState<InstituionLogin> {
  ...
  void _submit() async {
    ...
    try {
      ...
      final response = await authRepo.institutionLogin(
        _enteredEmail,
        _enteredPassword,
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('institution login'),
        actions: [
          IconButton(
